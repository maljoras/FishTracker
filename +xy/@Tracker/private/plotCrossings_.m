function plotCrossings_(self,section,updateIdx)
  ...
  for trackIndex = updateIdx
    ...
    if section==1
      ...
      fids = find(ismember(self.identityId2TrackId(t2,:),ids));
      ...
      %section 2
      fid = self.tracks(trackIndex).identityId;
  ...
  if section==2
    ...
    self.daGraph.plotTraceAssignments([self.tracks.predIdentityId],self.assignments,t-t0+1);
  end
end
