                 ...
                 int nrhs, const mxArray *prhs[])
{
  ...
  mwSize  i,j,k,n,m,m2,t,mt,nhyp,nfish,nele1,nele2,tidx;

  /* usage: otrace = backtrace_(dagIdx,dagPos,mt,ifish,mobj)*/
  
  /* Check proper input and output */
  if (nrhs != 5 ) {
    mexErrMsgTxt("5 inputs required. usage: backtrace_(dagIdx,dagPos,ifish,mobj,mt)");
  } else if (nlhs != 2) {
  ...
  mt = (mwSize) ((double *) mxGetData(prhs[4]))[0];
